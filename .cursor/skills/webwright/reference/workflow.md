...
Detailed expansion of the six-step Webwright loop, adapted for Cursor.
...
here by your native abilities (reading PNG files + reasoning against
`plan.md`). No extra model API keys are required when Cursor drives the loop.
